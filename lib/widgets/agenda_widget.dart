...
class AgendaWidget extends StatefulWidget {
  ...
  const AgendaWidget({super.key, this.agendaUrl});
...
class _AgendaWidgetState extends State<AgendaWidget> {
  ...
  void initState() {
    super.initState();
    if (widget.agendaUrl != null && widget.agendaUrl!.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    if (widget.agendaUrl == null || widget.agendaUrl!.isEmpty) {
      return Container(
        decoration: BoxDecoration(
          color: Colors.grey[100],
          border: Border.all(color: Colors.grey[300]!, width: 0.1),
    ...
    return _buildPdfViewer(widget.agendaUrl!);
  }
}
